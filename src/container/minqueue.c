...
MINQUEUE_ALL_IMPL(uchar)
MINQUEUE_ALL_IMPL(short)
MINQUEUE_ALL_IMPL(ushort)
MINQUEUE_ALL_IMPL(int)
MINQUEUE_ALL_IMPL(uint)
MINQUEUE_ALL_IMPL(long)
MINQUEUE_ALL_IMPL(ulong)
MINQUEUE_ALL_IMPL(llong)
MINQUEUE_ALL_IMPL(ullong)
MINQUEUE_ALL_IMPL(float)
MINQUEUE_ALL_IMPL(double)
MINQUEUE_ALL_IMPL(ldouble)
MINQUEUE_ALL_IMPL(bool)
...
MINQUEUE_ALL_IMPL(rawptr)
MINQUEUE_ALL_IMPL(cstr)
