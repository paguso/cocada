...
DEQUE_ALL_IMPL(char)
DEQUE_ALL_IMPL(uchar)
DEQUE_ALL_IMPL(short)
DEQUE_ALL_IMPL(ushort)
DEQUE_ALL_IMPL(int)
DEQUE_ALL_IMPL(uint)
DEQUE_ALL_IMPL(long)
DEQUE_ALL_IMPL(ulong)
DEQUE_ALL_IMPL(llong)
DEQUE_ALL_IMPL(ullong)
DEQUE_ALL_IMPL(float)
DEQUE_ALL_IMPL(double)
DEQUE_ALL_IMPL(ldouble)
DEQUE_ALL_IMPL(bool)
DEQUE_ALL_IMPL(size_t)
DEQUE_ALL_IMPL(int8_t)
DEQUE_ALL_IMPL(uint8_t)
DEQUE_ALL_IMPL(int16_t)
DEQUE_ALL_IMPL(uint16_t)
DEQUE_ALL_IMPL(int32_t)
DEQUE_ALL_IMPL(uint32_t)
DEQUE_ALL_IMPL(int64_t)
DEQUE_ALL_IMPL(uint64_t)
DEQUE_ALL_IMPL(byte_t)
DEQUE_ALL_IMPL(rawptr)
DEQUE_ALL_IMPL(cstr)
