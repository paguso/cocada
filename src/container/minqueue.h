...
MINQUEUE_ALL_DECL(uchar)
MINQUEUE_ALL_DECL(short)
MINQUEUE_ALL_DECL(ushort)
MINQUEUE_ALL_DECL(int)
MINQUEUE_ALL_DECL(uint)
MINQUEUE_ALL_DECL(long)
MINQUEUE_ALL_DECL(ulong)
MINQUEUE_ALL_DECL(llong)
MINQUEUE_ALL_DECL(ullong)
MINQUEUE_ALL_DECL(float)
MINQUEUE_ALL_DECL(double)
MINQUEUE_ALL_DECL(ldouble)
MINQUEUE_ALL_DECL(bool)
...
MINQUEUE_ALL_DECL(rawptr)
MINQUEUE_ALL_DECL(cstr)
