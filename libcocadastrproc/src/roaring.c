...
roaringbitvec *roaringbitvec_new(uint32_t n)
{
...
roaringbitvec *roaringbitvec_new_from_bitarr(byte_t *b, uint32_t n)
{
...
#define BKTRANK0(b) MIN(self->len, (b) * CTNR_SIZE) - segtree_range_qry_uint32_t(self->count_st, 0, b)
